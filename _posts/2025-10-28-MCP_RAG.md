...
Went full "production mode": query enhancement, cross-encoder re-ranking, semantic chunking, multi-signal scoring (Standard RAG →
Corrective RAG → Fusion RAG). 500 lines across 8 modules.
